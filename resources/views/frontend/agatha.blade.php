...
<html lang="en">
  ...
  <head>
    ...
    <title>Padc Judges - Agatha Carolina</title>
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <meta name="description" content="Agatha Carolina is one of our judges for Platinum Architectural Design Competiiton">
    <meta name="keywords" content="platinum architectural design Competiion, Design Competition, Architecture Competition, Architectural Competition, Interior Competition, Platinum Competition, commpetition, padc">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <meta property="og:description" content="Agatha Carolina is one of our judges for Platinum Architectural Design Competiiton" />
    <meta property="og:image" itemprop="image" content="{{asset('frontend/img/speakers/Agatha Carolina.jpg')}}" />
    <meta property="og:type" content="website" />
    <meta property="og:image:alt" content="PADC Judges -Agatha Carolina')">
    <meta property="og:image:type" content="image/jpeg">
    <meta property="og:image:width" content="256">
    <meta property="og:image:height" content="256">
    <link rel="canonical" href="https://padc-platinumceramisc.com/agatha-carolina" />	
        ...
        <div class="row justify-content-center py-1">
          <div class="col-md-6">
            <div class="row">
              ...
              <div class="col-md-12">
                <img src="{{asset('frontend/img/projects/dhsac-residence-bitte-design-studio_1.jpg')}}" alt="dhsac residence bitte design studio" class="img-fluid">
              </div>
          ...
          <div class="row justify-content-center py-1">
            <div class="col-md-6">
                <div class="row">
                     <div class="col-md-12">
                        <div class="details pt-2">
                             <h3>Islamic Boarding School Tahfizh Akhwat </h3>
                        </div>
                      </div>
               
                      <div class="col-md-12">
                        <img src="{{asset('frontend/img/projects/Asrama_Pesantren_Tahfiz_Cimanggis_-_1.jpg')}}" alt="asrama pesantren tahfiz cimanggis" class="img-fluid">
                      </div>
                </div>
              </div>
          </div>
           <div class="row justify-content-center py-1">
            <div class="col-md-6">
                <div class="row">
                     <div class="col-md-12">
                        <div class="details pt-2">
                             <h3>Beer Hall, Jakarta </h3>
                        </div>
                      </div>
               
                      <div class="col-md-12">
                        <img src="{{asset('frontend/img/projects/BEER HALL, JAKARTA.JPG')}}" alt="beer hall, Jakarta" class="img-fluid">
                        <p></p>
                      </div>
                      </br>
                       <div class="col-md-12 ">
                       
                         <img src="{{asset('frontend/img/projects/BEER HALL.jpg')}}" alt="beer hall, Jakarta" class="img-fluid">
                      </div>
                </div>
              </div>
          </div>
           <div class="row justify-content-center py-1">
            <div class="col-md-6">
                <div class="row">
                     <div class="col-md-12">
                        <div class="details pt-2">
                             <h3>Bowery, Semarang </h3>
                        </div>
                      </div>
               
                      <div class="col-md-12 ">
                        <img src="{{asset('frontend/img/projects/BOWERY, SEMARANG.jpg')}}" alt="bowery, semarang" class="img-fluid">
                        <p></p>
                      </div>
                     
                       <div class="col-md-12 ">
                        
                        <img src="{{asset('frontend/img/projects/BOWERY.jpg')}}" alt="bowery, semarang" class="img-fluid">
                      </div>
                </div>
              </div>
          </div>
