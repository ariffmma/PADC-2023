...
<!--<![endif]-->
    <div class="wrapper" style="min-width: 320px;background-color: #f5f7fa;" lang="x-wrapper">
      ...
      <div class="layout one-col fixed-width" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 173000px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
        <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;background-color: #000000;" lang="x-layout__inner">
        <!--[if (mso)|(IE)]><table align="center" cellpadding="0" cellspacing="0"><tr class="layout-fixed-width" style="background-color: #000000;"><td style="width: 600px" class="w560"><![endif]-->
      ...
      <img height="40" style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #44a8c7;font-size: 36px;line-height: 43px;font-family: bitter,georgia,serif;text-align: center;" src="https://padc.anabata.id/frontend/img/logo.png" title="logo" alt="logo">
    </div>
      ...
      <p style="Margin-top: 20px;Margin-bottom: 20px;"><strong>{{ Illuminate\Mail\Markdown::parse($slot) }}
...
<td class="emb-web-links" style="padding: 0;width: 26px;"><a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #b9b9b9;" href="https://www.facebook.com/platinumceramicsindustry"><img style="border: 0;" src="https://i8.createsend1.com/static/eb/customise/13-the-blueprint-3/images/facebook.png" width="26" height="26"></a></td><td class="emb-web-links" style="padding: 0 0 0 3px;width: 26px;"><a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #b9b9b9;" href="https://twitter.com/PlatinumCeramic"><img style="border: 0;" src="https://i10.createsend1.com/static/eb/customise/13-the-blueprint-3/images/twitter.png" width="26" height="26"></a></td><td class="emb-web-links" style="padding: 0 0 0 3px;width: 26px;"><a 
style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #b9b9b9;" href="http://instagram.com/platinumcompetition/"><img style="border: 0;" src="https://i1.createsend1.com/static/eb/customise/13-the-blueprint-3/images/instagram.png" width="26" height="26"></a></td>
              </tr></tbody></table>
              <div style="Margin-top: 20px;">
                <div>Copyright &#169; 2022 . Platinum Architectural Design Competition &nbsp;</div>
              </div>
...
<head>
    ...
    <title>Anabata</title>
    <meta name="description" content="Reset Password Email Anabata.">
    <style type="text/css">
        ...
        <tr>
            <td>
                <table style="background-color: #f2f3f8; max-width:670px;  margin:0 auto;" width="100%" border="0"
                    ...
                    <tr>
                        <td style="text-align:center;">
                          <a href="" title="logo" target="_blank">
                            <img width="auto" height="40" src="https://anabata.com/frontend/img/core-img/nitip-PADC.png" title="logo" alt="logo">
                          </a>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="text-align:center;">
                            <p style="font-size:14px; color:rgba(69, 80, 86, 0.7411764705882353); line-height:18px; margin:0 0 0;"> <strong>If you have any question, please contact us via <a href="mailto:info@anabata.com">info@anabata.com</a></strong></p>
                        </td>
                        
                    </tr>
                    <tr>
                        <td style="text-align:center;">
                            <p style="font-size:14px; color:rgba(69, 80, 86, 0.7411764705882353); line-height:18px; margin:0 0 0;">&copy; <strong><a href="https://www.platinumceramics.com/">www.platinumceramics.com</a></strong></p>
                        </td>
